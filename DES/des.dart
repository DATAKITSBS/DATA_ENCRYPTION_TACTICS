...
class DES {
  ...
  static const _pc1 = [56, 48, 40, 32, 24, 16,  8,
    0, 57, 49, 41, 33, 25, 17,
    9,  1, 58, 50, 42, 34, 26,
    18, 10,  2, 59, 51, 43, 35,
  ...
  static const _ip = [57, 49, 41, 33, 25, 17, 9,  1,
  ...
  List<int> _desCrypt(List<int> block, int cryptType) {
    ...
    for (int i = 0; i < 16; i++, iteration += iterationAdjustment) {
      ...
      List<List<int>> B = [
        right.sublist(0, 6), right.sublist(6, 12),
        right.sublist(12, 18), right.sublist(18, 24),
        right.sublist(24, 30), right.sublist(30, 36),
        right.sublist(36, 42), right.sublist(42)
      ];
  ...
  List<int> crypt(List<int> data, int cryptType) {
    ...
    if (data.length % BLOCK_SIZE != 0) {
      if (cryptType == _DECRYPT) { // Decryption must work on 8 byte blocks
